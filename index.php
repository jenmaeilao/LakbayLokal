...
<body>
  ...
  <section class="dest-section" id="destinations">
    ...
    <div class="region-tabs">
      ...
      <button class="tab-btn" onclick="filterDest('mindanao', this)">Mindanao</button>
    </div>
    <div class="dest-grid" id="destGrid">
      ...
      <div class="dest-card" data-region="luzon">
        <div class="dest-img">
          ...
          <div class="dest-img-info">
            <h3>Baguio City</h3><span>Benguet, CAR</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">Highlands</span><span class="tag">Strawberries</span><span
              class="tag">Cafés</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.8 <small style="color:#999;font-weight:400">(234)</small></div><button
              class="btn-explore" onclick="selectDest('Baguio City')">Explore →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="luzon">
        <div class="dest-img">
          ...
          <div class="dest-region-badge">Luzon</div>
          <div class="dest-img-info">
            <h3>Vigan City</h3><span>Ilocos Sur</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">Heritage</span><span class="tag">Kalesa</span><span
              class="tag">Empanada</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.7</div><button class="btn-explore" onclick="selectDest('Vigan City')">Explore
              →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="luzon">
        <div class="dest-img">
          ...
          <div class="dest-region-badge">Luzon</div>
          <div class="dest-img-info">
            <h3>Palawan</h3><span>MIMAROPA</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">Islands</span><span class="tag">Diving</span><span
              class="tag">Wildlife</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.9</div><button class="btn-explore" onclick="selectDest('Palawan')">Explore
              →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="visayas">
        <div class="dest-img">
          ...
          <div class="dest-img-info">
            <h3>Boracay</h3><span>Aklan</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">White Beach</span><span class="tag">Parasailing</span><span
              class="tag">Water Sports</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.9 <small style="color:#999;font-weight:400">(512)</small></div><button
              class="btn-explore" onclick="selectDest('Boracay')">Explore →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="visayas">
        <div class="dest-img">
          ...
          <div class="dest-region-badge">Visayas</div>
          <div class="dest-img-info">
            <h3>Cebu City</h3><span>Cebu</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">History</span><span class="tag">Whale Sharks</span><span
              class="tag">Canyoneering</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.8</div><button class="btn-explore" onclick="selectDest('Cebu City')">Explore
              →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="visayas">
        <div class="dest-img">
          ...
          <div class="dest-region-badge">Visayas</div>
          <div class="dest-img-info">
            <h3>Siargao</h3><span>Surigao del Norte</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">Surfing</span><span class="tag">Lagoons</span><span
              class="tag">Snorkeling</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.8</div><button class="btn-explore" onclick="selectDest('Siargao')">Explore
              →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="visayas">
        <div class="dest-img">
          ...
          <div class="dest-region-badge">Visayas</div>
          <div class="dest-img-info">
            <h3>Bohol</h3><span>Bohol</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">Chocolate Hills</span><span class="tag">Tarsier</span><span
              class="tag">River Cruise</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.7</div><button class="btn-explore" onclick="selectDest('Bohol')">Explore
              →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="mindanao">
        <div class="dest-img">
          ...
          <div class="dest-img-info">
            <h3>Bukidnon</h3><span>Mindanao</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">Highlands</span><span class="tag">Camping</span><span
              class="tag">Festivals</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.6</div><button class="btn-explore" onclick="selectDest('Bukidnon')">Explore
              →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="mindanao">
        <div class="dest-img">
          ...
          <div class="dest-region-badge">Mindanao</div>
          <div class="dest-img-info">
            <h3>Davao City</h3><span>Davao del Sur</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">Eagles</span><span class="tag">Fruits</span><span class="tag">Mt.
              Apo</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.7</div><button class="btn-explore" onclick="selectDest('Davao City')">Explore
              →</button>
          </div>
        </div>
      </div>
      ...
      <div class="dest-card" data-region="mindanao">
        <div class="dest-img">
          ...
          <div class="dest-region-badge">Mindanao</div>
          <div class="dest-img-info">
            <h3>Camiguin</h3><span>Camiguin</span>
          </div>
        </div>
        <div class="dest-body">
          <div class="dest-tags"><span class="tag">Volcanoes</span><span class="tag">Hot Springs</span><span
              class="tag">Ruins</span></div>
          <div class="dest-meta">
            <div class="dest-rating">⭐ 4.8</div><button class="btn-explore" onclick="selectDest('Camiguin')">Explore
              →</button>
          </div>
        </div>
      </div>
  ...
  <section class="hotels-section" id="hotels">
    ...
    <div class="hotels-grid">
      ...
      <div class="hotel-card">
        ...
        <a href="https://www.wyndhamhotels.com/microtel/baguio-city-philippines" target="_blank" class="btn-hotel">View
          Hotel →</a>
      </div>
  ...
  <section class="reviews-section" id="reviews">
    ...
    <div class="reviews-grid">
      <div class="review-card">
        ...
        <p class="review-text">"Baguio was absolutely magical! The strawberry farm tour was my favorite — fresh picks
          and amazing views. LakbayPH made the whole booking so easy."</p>
      ...
      <div class="review-card">
        <div class="review-stars">★★★★★</div>
        <p class="review-text">"Boracay's White Beach is everything they say and more. Parasailing was a highlight! The
          itinerary builder helped me maximize every single day."</p>
        <div class="review-author">
      ...
      <div class="review-card">
        <div class="review-stars">★★★★☆</div>
        <p class="review-text">"Cebu canyoneering was a life experience. Loved how the platform showed me all activities
          nearby the hotel I picked. Super convenient!"</p>
        <div class="review-author">
